...
<body class="hold-transition sidebar-mini">
  <div class="wrapper">
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
      ...
      <div class="sidebar">
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
          ...
          <div class="info">
            <a href="{{ route('admin_dashboard') }}" class="d-block">{{ Auth::user()->firstname }}
              {{ Auth::user()->name }}</a>
          </div>
        </div>
        <!-- Sidebar Menu -->
        <nav class="mt-2">
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <ul class="nav nav-treeview"> --}}
              ...
              <li class="nav-item">
                <a href=" {{ route('video.index') }}" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Uploader un lien vidéo</p>
                </a>
              </li>
              <li class="nav-item">
              ...
              <li class="nav-item">
                <a href="{{ route('questions') }}" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Accéder aux réactions</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{ route('tracker') }}" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Accéder aux statistiques</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{ route('indexMail') }}" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Envoyer des mails</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{ route('logout') }} " class="nav-link active" style="background-color: red;">
    ...
    <footer class="main-footer">
      ...
      <!-- Default to the left -->
      <strong>Copyright &copy; 2021 <a href="https://bmvcom.eu">BMV Communication</a>.</strong> Tous droits réservés.
    </footer>
  </div>
  <!-- ./wrapper -->
  <!-- REQUIRED SCRIPTS -->
